...
int jogodecarta() {
    ...
    //printf("Quantos jogadores vao jogar (2 a 4): ");
        ...
        while (indiceDoDeck < 52 && !alguemFez21) {
            ...
            for (i = 0; i < quantidadeJogadores; i++) {
                ...
                if (soma < 21 && jg[i].dedos > 0) {
                    char escolha;
                    printf("Deseja cavar uma carta? (s/n): ");
                    scanf(" %c", &escolha);
